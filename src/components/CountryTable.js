...
function createTableData(countries) {
    if (countries.length) {
        const tableData = countries.map((data) => (
            {
...
const headCells = [
    { id: 'country', numeric: false, disablePadding: false, label: 'Country/Region' },
...
export default function CountryTable({ countries }) {
    ...
    const rows = createTableData(countries)
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        <TableRow
                                            ...
                                            key={row.country}
                                        >
                                            <TableCell component="th" id={labelId} scope="row" padding="2px" align="left">
                                                {row.country}
                                            </TableCell>
                                            <TableCell align="right">{numeral(row.confirmed).format("0,0")}</TableCell>
                                            <TableCell align="right">{numeral(row.active).format("0,0")}</TableCell>
                                            <TableCell align="right">{numeral(row.recovered).format("0,0")}</TableCell>
