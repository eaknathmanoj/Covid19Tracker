...
function App() {
  ...
  //onInit
  useEffect(() => {
    const countryCode = localStorage.getItem("bookMarkCountry")
      ? localStorage.getItem("bookMarkCountry")
      : "worldwide";
    const url =
  ...
  const bookMark = (countryCode) => {
    localStorage.setItem("bookMarkCountry", countryCode);
  };
